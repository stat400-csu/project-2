...
Is that we used d not have survivorship random

We used the 1982  census net immigration projection
Used the same survivorship for 85-100 age bins, even though they are supposed to decrease towards 0 since 100 year olds can’t survive to the next age bin
We used 1982's fertility for 2010's 10-14 age bin
We did not use the life expectancy rates like the author did
