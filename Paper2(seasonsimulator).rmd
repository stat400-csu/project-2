...
Elevation I did ((Stadium Elevation - NFL Average Elevation)/1000 *0.7) where dividing by 1000 to scale down to a point advantage and then multiplying by 0.7 to a elevation point advantage.
